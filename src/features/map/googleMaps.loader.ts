...
export function loadGoogleMaps(): Promise<void> {
  ...
  loading = new Promise((resolve, reject) => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=${encodeURIComponent(env.googleMapsApiKey)}&loading=async&callback=initTravelPickMap&language=ko&region=KR`;
    script.async = true;
